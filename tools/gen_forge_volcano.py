...
def main():
    ...
    print()
    print("region l rock=basalt fertility=low surface=barren climate=lush sandy=0.35 wildgrass=0.06 stones=0.05 height=0.05 shore=8 rough=0.15")
    print("region t rock=basalt fertility=terrapreta surface=barren climate=lush wildgrass=0.10 stones=0.04 devastation=0.04 height=0.10 shore=6 rough=0.20")
    print("region w rock=basalt fertility=verylow surface=rock climate=lush stones=0.05 height=0.28 shore=6 rough=0.30")
    print("region x rock=basalt surface=rock climate=lush stones=0.04 height=0.52 shore=6 rough=0.30")
    print("region y rock=basalt surface=rock climate=lush stones=0.04 height=0.76 shore=6 rough=0.30")
    print("region z rock=basalt surface=rock climate=lush height=1.0 shore=6 rough=0.25")
