...
# (distance from main centre, half-len along, half-wid across, height)
TEETH = [
    (38.0, 6.0, 3.0, 1.0), (55.0, 5.5, 2.7, 0.95), (70.0, 4.5, 2.3, 1.0), (82.0, 3.5, 1.8, 0.9),
    (-38.0, 5.0, 2.6, 0.95), (-50.0, 4.0, 2.0, 1.0),
]

# Spires: the same ridge punching up THROUGH the island interior.
...
def main():
    ...
    print("# saltteeth_island - white chalk karst impaled on a ridge of blades: teeth")
    print("# row runs THROUGH the island (interior spires) and out both sides, with")
    print("# scattered shards and one-block-under lurker reefs all around the coast.")
    ...
    print(f"region S rock=chalk rock2=limestone surface=rocksand ores=quartz:0.05 boulders=0.014 stones=0.03 height=0.92 shore=5 rough=0.24 {clim}")
    print(f"region P rock=chalk rock2=limestone surface=rock ores=quartz:0.05 boulders=0.010 height=1.28 shore=2 rough=0.35 {clim}")
    print(f"region T rock=chalk rock2=halite fertility=verylow surface=barren ores=quartz:0.05 wildgrass=0 stones=0.03 boulders=0.008 height=0.65 shore=6 rough=0.14 {clim}")
    ...
    print(f"region E rock=chalk surface=rock boulders=0.020 stones=0.02 height=1.05 shore=2 rough=0.45 {clim}")
    print(f"region F rock=chalk surface=rock boulders=0.015 stones=0.02 height=0.88 shore=2 rough=0.45 {clim}")
    print(f"region J rock=chalk surface=rock boulders=0.02 height=0.85 shore=1 rough=0.50 {clim}")
