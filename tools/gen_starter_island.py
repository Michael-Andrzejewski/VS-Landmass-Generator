...
def main():
    ...
    print("region F rock=slate rock2=peridotite fertility=medium surface=grass ores=copper:sparse forest=0.015 trees=oak copperbits=0.0012 bushes=raspberry:0.012 sticks=0.04 litter=0.8 scatter=fieldmushroom:0.006,flyagaric:0.003,eaglefern:0.025,deerfern:0.012,horsetail:0.010 height=0.75 shore=16 rough=0.08")
    ...
    print("region R rock=slate rock2=peridotite surface=rock     ores=copper:rich copperbits=0.0025 boulders=0.010 height=1.0 shore=16 rough=0.12")
