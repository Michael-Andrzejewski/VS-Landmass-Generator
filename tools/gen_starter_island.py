...
def main():
    ...
    print("region F rock=slate rock2=peridotite fertility=medium surface=grass ores=copper:sparse forest=0.015 trees=oak copperbits=0.01 bushes=raspberry:0.012 sticks=0.04 litter=0.18 scatter=fieldmushroom:0.006,flyagaric:0.003,eaglefern:0.025,deerfern:0.012 height=0.75 shore=16 rough=0.08")
