...
def main():
    ...
    print()
    print("region P rock=slate rock2=peridotite fertility=medium surface=grass ores=copper:medium bushes=raspberry:0.002,blueberry:0.002 height=0.70 shore=16 rough=0.08")
    print("region F rock=slate rock2=peridotite fertility=medium surface=grass ores=copper:sparse forest=0.015 trees=oak copperbits=0.01 bushes=raspberry:0.012 sticks=0.04 litter=0.18 height=0.75 shore=16 rough=0.08")
    print("region H rock=slate rock2=peridotite fertility=high   surface=grass ores=copper:medium bushes=cranberry:0.01 height=0.70 shore=16 rough=0.06")
    print("region X rock=slate rock2=peridotite fertility=medium surface=grass ores=copper:medium flax=0.05 bushes=blackcurrant:0.005,redcurrant:0.005 height=0.70 shore=16 rough=0.08")
    print("region L rock=slate                  fertility=low    surface=grass ores=copper:medium bushes=cranberry:0.008 height=0.55 shore=14 rough=0.12")
    print("region B rock=slate sand=sand-chalk  surface=sand     bushes=birch:0.006,strawberry:0.003 height=0.16 shore=36 rough=0.03")
    print("region T rock=slate sand=sand-chalk  surface=sand     bushes=birch:0.006,strawberry:0.003 height=0.16 shore=36 rough=0.03 cattails=1.0")
    print("region C rock=slate sand=sand-slate  surface=rocksand height=0.60 shore=3  rough=0.10")
    print("region R rock=slate rock2=peridotite surface=rock     ores=copper:rich height=1.0 shore=16 rough=0.12")
